...
<p>Has the same effect as <code><a href="../serge-pull-ts/">serge pull-ts --force</a></code> and <code><a href="../serge-localize/">serge localize --force</a></code> combined.</p>

</dd>
<dt><b>--rebuild-ts-files</b></dt>
<dd>

<p>Has the same effect as <code><a href="../serge-localize/">serge localize --rebuild-ts-files</a></code>.</p>

</dd>
<dt><b>--output-only-mode</b></dt>
<dd>

<p>Has the same effect as <code><a href="../serge-localize/">serge localize --output-only-mode</a></code>.</p>
...
<dt><b>--message=&quot;commit message&quot;</b></dt>
<dd>

<p>When pushing localized data back to version control, override the commit message with the provided one.</p>
