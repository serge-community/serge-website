...
<p>This plugin provides integration with <a href="https://www.gerritcodereview.com/">Gerrit</a>-based source code repositories. Gerrit is a code review system built on top of Git, and it has a different way of submitting changes to the remote server (no direct `git push`). This plugin inherits its core behavior and settings from the <a href="/docs/plugins/vcs/git/">git plugin</a>, and automatically self-reviews the committed change in Gerrit.</p>
