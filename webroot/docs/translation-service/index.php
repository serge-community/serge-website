...
<p>Such functionality is realized by the means of <a href="/docs/plugins/<?php echo $ts_plugins[0] ?>">translation service plugins</a>, which need to know how to send a specified directory of .po files to an external service and how to get the files back into file system.</p>

<p>At Evernote, we use Serge in a combination with <a href="http://pootle.translatehouse.org/">Pootle</a> — a free open-source online translation server software. You can use Pootle plugin's code (located in <code>&lt;serge_root&gt;/lib/Serge/Sync/Plugin/TranslationService/pootle.pm</code>) as a reference implementation for your own plugins.</p>
