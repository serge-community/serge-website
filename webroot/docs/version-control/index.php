...
<p>Each system is supported by the means of <a href="/docs/plugins/<?php echo $vcs_plugins[0] ?>">VCS plugins</a>, and you can write your own VCS integration plugins. You can use existing plugins code (located in <code>&lt;serge_root&gt;/lib/Serge/Sync/Plugin/VCS</code> folder) as an inspiration.</p>
