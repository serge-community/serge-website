...
<p>At its core, Serge is a <a href="/documentation/command-line-interface/">command-line tool</a> that can be either run manually on a developers' computer, or automatically (e.g. as a cron job) on a server, to achieve <a href="/documentation/continuous-localization/">continuous localization integration</a>. After you have it <a href="/download/">downloaded and installed</a>, you can simply run it by saying `<code>serge</code>` in the command line, which will give you a <a href="/documentation/help/serge/">quick help</a> and a <a href="/documentation/command-line-interface/#available-commands">list of available commands</a>.</p>

<p>All localization-related settings need to be described in <a href="/documentation/configuration-files/">configuration files</a>. When run against a configuration file, Serge will perform one <a href="/documentation/localization-cycle/">localization cycle</a>, bring localized resources in sync with their source, generate new ones, and apply all known translations that come from .po files. It will handle synchronization with your <a href="/documentation/version-control/">version control system</a>, automatically pulling and pushing changes, and will also synchronize with an external <a href="/documentation/translation-service/">translation service</a>.</p>
