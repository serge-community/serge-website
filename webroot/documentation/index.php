...
<p>Two core Serge commands are <code><a href="/help/serge-sync.php">sync</a></code> and <code><a href="/help/serge-localize.php">localize</a></code>:</p>
...
<ol>
    <li>Pull source files from the remote development repository (<code><a href="/help/serge-pull.php">serge pull</a></code>)</li>
    <li>Pull .po files from <a href="#translation-services">external translation service</a> (<code><a href="/help/serge-pull-po.php">serge pull-po</a></code>)</li>
    <li>Perform a localization cycle (<code><a href="/help/serge-localize.php">serge localize</a></code>):
        <ol>
    ...
    <li>Push .po files to an <a href="#translation-services">external translation service</a> (<code><a href="/help/serge-push-po.php">serge push-po</a></code>)</li>
    <li>Push generated localized files back to the remote repository (<code><a href="/help/serge-push.php">serge push</a></code>)</li>
</ol>
