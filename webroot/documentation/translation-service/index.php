...
<p>A part of Serge's <a href="/documentation/localization-cycle/">localization+sync cycle</a> is a two-way synchronization with an external translation service. Specifically, two steps, <code><a href="/documentation/help/serge-pull-po/">pull-po</a></code> and <code><a href="/documentation/help/serge-push-po/">push-po</a></code>, are used to get translated .po files from an push these files back to external translation service.</p>
...
<p>Note that Serge is very flexible when it comes to <a href="/documentation/configuration-files/">configuration</a>. You can send select translation projects to a localization vendor, while using crowdsourcing service to translate the rest.</p>
