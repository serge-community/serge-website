...
<p>A part of Serge's <a href="/documentation/localization-cycle/">localization+sync cycle</a> is a two-way synchronization with a version control system (VCS). Specifically, two steps, <code><a href="/documentation/help/serge-pull/">pull</a></code> and <code><a href="/documentation/help/serge-push/">push</a></code>, are used to get source files from VCS and place localized files back to VCS.</p>
...
<p>VCS are defined on a per-<a href="/documentation/configuration-files/">configuration file</a> basis. So you can have some translation projects working with Git, and others with SVN, for example. Also, each translation project can define one or more repositories to pull data from.</p>
