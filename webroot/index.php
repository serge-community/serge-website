...
<div class="table">
    <div style="width: 410px; padding-right: 80px">
        ...
        <p><strong style="cursor: help" title="'Serge' stands for 'String Extraction and Resource Generation Engine'">Serge</strong> helps you set up a seamless <a href="/docs/continuous-localization/">continuous localization process</a> for your software and marketing assets in a fully automated and scalable fashion. It will fit perfectly into your agile development cycle.</p>
        ...
        <p><a href="/docs/">I want to learn more!</a></p>
    </div>
